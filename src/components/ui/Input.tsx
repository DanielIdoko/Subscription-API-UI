  ...
  ({ label, error, hint, className = "", type, ...props }, ref) => {
    ...
    return (
      <div className="w-full">
        {label && (
          <label
            className="block text-sm font-sans px-1 text-gray-900 dark:text-gray-100 mb-2"
            htmlFor={type}
          >
            {label}
          </label>
        ...
        <div className="relative">
          <input
            ...
            className={`w-full px-4 py-2.5 rounded-full border transition-colors bg-white dark:bg-slate-900 text-gray-900 dark:text-gray-100 ${
              error
                ...
                : "border-dark/20 focus:ring-blue-500 dark:border-slate-700 dark:focus:ring-blue-500"
          ...
          {isPassword && (
            ...
            >
              {showPassword ? (
                <FiEyeOff className="w-4 h-4 cursor-pointer" />
              ) : (
